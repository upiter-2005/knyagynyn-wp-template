	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				 ...
				 */
                ?>
                <tr valign="top"><th scope="row"><?php _e( 'Готовність житлового району % ', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[procent]" class="regular-text" type="text" name="sample_theme_options[procent]" value="<?php esc_attr_e( $options['procent'] ); ?>" />
					</td>
				</tr>
				<!-- <tr valign="top"><th scope="row"><?php _e( 'Телефон 050', 'sampletheme' ); ?></th>
					<td>
				...
				<tr valign="top"><th scope="row"><?php _e( 'Телефон 073', 'sampletheme' ); ?></th>
					<td>
				...
				<tr valign="top"><th scope="row"><?php _e( 'Телефон 096', 'sampletheme' ); ?></th>
					<td>
				...
				<tr valign="top"><th scope="row"><?php _e( 'Телефон 063', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[phonetext4]" class="regular-text" type="text" name="sample_theme_options[phonetext4]" value="<?php esc_attr_e( $options['phonetext4'] ); ?>" />
					</td>
				</tr>
        ...
        <tr valign="top"><th scope="row"><?php _e( 'Адрес', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[adres]" class="regular-text" type="text" name="sample_theme_options[adres]" value="<?php esc_attr_e( $options['adres'] ); ?>" />
					</td>
				</tr> -->
